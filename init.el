...
(use-package buffers ;; My package
  ...
  :bind (([(control c) (k)] . buffers-kill-current)))
...
(use-package fill-column-indicator
  :ensure t
  :commands (fci-mode)
  :hook ((1ml-mode sh-mode c-mode c++-mode cmake-mode markdown-mode reason-mode) . fci-mode))
...
(use-package prettier-js
  ...
  :hook ((rjsx-mode less-css-mode css-mode markdown-mode typescript-mode)
         . prettier-js-mode))
